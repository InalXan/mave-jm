                ...
                <form class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" placeholder="Jane" class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/60">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold">Soyisim</label>
                            <input type="text" placeholder="Doe" class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/60">
                        </div>
                    </div>

                    <div>
                        <label class="block text-sm font-semibold">Yaşınız</label>
                        <input type="number" placeholder="35" class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/60">
                    </div>

                    <div>
                        <label class="block text-sm font-semibold">Gitmek istediğiniz ülke</label>
                        <input type="text" placeholder="Germany" class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/60">
                    </div>

                    <div>
                        <label class="block text-sm font-semibold">Vize Türü</label>
                        <select class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/60">
                            <option>İş</option>
                            <option>Gezi</option>
                            <option>Turistik</option>
                            <option>Schengen</option>
                            <option>Aile birleşimi</option>
                            <option>Tır şoförü vizesi</option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold">Daha once vize aldinizmi?</label>
                        <select class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/60">
                            <option>Evet</option>
                            <option>Hayir</option>
                        </select>
                    ...
                    <div>
                        <label class="block text-sm font-semibold">Daha once vize reddi aldinizmi?</label>
                        <select class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/60">
                            <option>Evet</option>
                            <option>Hayir</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="email" placeholder="john@gmail.com" class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-400">
                    </div>

                    <div>
                        <label class="block text-sm font-semibold">Telefon</label>
                        <input type="number" placeholder="0 (548) ** **" class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-400">
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/60">
                                ...
                                <option>İşveren</option>
                                <option>Emekli</option>
                                <option>Memur</option>
                                <option>Çalışmayan</option>
                            </select>
                        </div>
                    </div>

                    <div>
                            <label class="block text-sm font-semibold">Ayni is yerinde kac yildir calisiyorsunuz?</label>
                            <select class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/60">
                                <option>1 yildan az</option>
                                <option>1 yildan fazla</option>
                                <option>3 yildan fazla</option>
                                <option>5 yildan fazla</option>
                            </select>
                        </div>
                        <div>
                        <label class="block text-sm font-semibold">Maasiniz banka hesabiniza yatiyormu?</label>
                        <select class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/60">
                            <option>Evet</option>
                            <option>Hayir</option>
                        </select>
                    ...
                    <div>
                        ...
                        <textarea rows="4" class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/60"></textarea>
                    </div>

                    <button type="submit" class="w-full bg-primary text-white py-3 rounded-lg font-bold hover:bg-primary/80 transition">Gönder</button>
                </form>
            </div>
        </div>
    </section>
