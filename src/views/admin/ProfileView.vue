			...
			<div class="bg-second/10 backdrop-blur-md border border-primary shadow-lg  rounded-3xl p-4 m-4">
				<div class="flex-none sm:flex">
					<div class=" relative h-32 w-32   sm:mb-0 mb-3">
						<img src="@/assets/images/admin/layoutlore/single.png" alt="aji" class=" w-32 h-32 object-cover rounded-2xl">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
							...
							<div class="flex pt-2  text-sm text-gray-500">
								<div class="flex-1 inline-flex items-center">
									...
									<p class="">1 kullanicilarin sayi</p>
								</div>
								<div class="flex-1 inline-flex items-center">
									<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20"
										fill="currentColor">
									...
									<p class="">14 paylasilan icerikler</p>
								</div>
