<template>
  ...
  <div class="sm:w-[95%] w-[85%] float-end min-h-screen">
    <!-- profile  -->
     <div class="w-full flex justify-center items-center">
		...
		<div class="flex flex-col">
			<div class="bg-second/10 backdrop-blur-md border border-primary shadow-lg  rounded-3xl p-4 m-4">
				<div class="flex-none sm:flex">
					<div class=" relative h-32 w-32   sm:mb-0 mb-3">
						<img src="@/assets/images/logo/logo.png" alt="aji" class=" w-32 h-32 object-cover rounded-2xl">
					...
					<div class="flex-auto sm:ml-5 justify-evenly">
						<div class="flex items-center justify-between sm:mt-2">
							<div class="flex items-center">
								<div class="flex flex-col">
									<div class="w-full flex text-lg text-primary font-bold leading-none m-2"><h1>mave-jm admin kullanicisi</h1><span class="text-gray-400 mx-2">#123123123</span></div>
									<div class="flex-auto text-gray-500 my-1">
										<span class="mr-3 ">Yetki</span><span class="mr-3 border-r border-primary  max-h-0"></span><span>Tam</span>
									</div>
								</div>
							</div>
						</div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
							...
							<div class="flex flex-wrap pt-2  text-sm text-gray-500">
								<div class="flex-1 inline-flex items-center">
									...
									<p class="">{{ stats.totalVisits }} Toplam ziyaretciler</p>
								</div>
								<div class="flex-1 inline-flex items-center">
									<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20"
										fill="currentColor">
									...
									<p class="">{{ stats.uniqueVisitors }} Su anda ziyaret edenler</p>
								</div>
								<a href="https://layoutlore.com"  class="flex justify-center items-center bg-primary hover:bg-primary/70 px-5 ml-4 py-2 text-xs shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-primary/50 hover:border-primary cursor-pointer text-second rounded-full transition ease-in duration-300">layoutlore LLC <ion-icon class="text-xl" name="arrow-forward-circle"></ion-icon></a>
							</div>
						</div>
					</div>
				</div>
    ...
    <!-- stats  -->
    <div class="flex items-center w-full bg-gray-200 text-gray-800">
    ...
    <div class="grid grid-cols-12 gap-4">
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">Toplam ziyaretci</div>
            <div class="font-bold text-lg">{{ stats.totalVisits }}</div>
          </div>
        </div>
      </div>
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
      ...
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">Paylasilan icerikler</div>
            <div class="font-bold text-lg">{{ stats.uniqueVisitors }}</div>
          </div>
        </div>
      </div>
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
...
import SidebarComponent from "@/components/SidebarComponent.vue";
    ...
    const stats = ref({ totalVisits: 0, uniqueVisitors: 0 });
