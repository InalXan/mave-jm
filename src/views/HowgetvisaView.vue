        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 xl:gap-12 px-2 xl:px-12 mt-4">
            ...
            <div class="flex flex-col space-x-8 mt-8">
                ...
                <div>
                    ...
                    <p class="text-gray-600 my-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, dignissimos. Neque eos, dignissimos provident reiciendis debitis repudiandae commodi perferendis et itaque, similique fugiat cumque impedit iusto vitae dolorum. Nostrum, fugit!</p>
                    <a href="#" class="text-primary/70 hover:text-primary hover:underline capitalize" title="Read More">Read More</a>
                </div>
            </div>
            ...
            <div class="flex flex-col space-x-8 mt-8">
                ...
                <div>
                    ...
                    <p class="text-gray-600 my-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, dignissimos. Neque eos, dignissimos provident reiciendis debitis repudiandae commodi perferendis et itaque, similique fugiat cumque impedit iusto vitae dolorum. Nostrum, fugit!</p>
                    <a href="#" class="text-primary hover:text-primary hover:underline capitalize" title="Read More">Read More</a>
                </div>
            </div>
            ...
            <div class="flex flex-col space-x-8 mt-8">
                ...
                <div>
                    ...
                    <p class="text-gray-600 my-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, dignissimos. Neque eos, dignissimos provident reiciendis debitis repudiandae commodi perferendis et itaque, similique fugiat cumque impedit iusto vitae dolorum. Nostrum, fugit!</p>
                    <a href="#" class="text-primary hover:text-primary/20 hover:underline capitalize" title="Read More">Read More</a>
                </div>
            </div>
        </div>
    </div>
